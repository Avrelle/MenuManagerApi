 ...
 */
final class Version20231011135947 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu_plate (menu_id INT NOT NULL, plate_id INT NOT NULL, INDEX IDX_E032F43CDF66E98B (plate_id), INDEX IDX_E032F43CCCD7E912 (menu_id), PRIMARY KEY(menu_id, plate_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE plate_menu (plate_id INT NOT NULL, menu_id INT NOT NULL, INDEX IDX_15C9E83FCCD7E912 (menu_id), INDEX IDX_15C9E83FDF66E98B (plate_id), PRIMARY KEY(plate_id, menu_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
