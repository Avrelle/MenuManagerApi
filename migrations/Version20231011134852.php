 ...
 */
final class Version20231011134852 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plate_menu (plate_id INT NOT NULL, menu_id INT NOT NULL, INDEX IDX_15C9E83FDF66E98B (plate_id), INDEX IDX_15C9E83FCCD7E912 (menu_id), PRIMARY KEY(plate_id, menu_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
